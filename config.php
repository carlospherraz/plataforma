...
define('FS_DB_NAME', 'denergic_db');
define('FS_DB_USER', 'denergic'); /// MYSQL -> root, POSTGRESQL -> postgres
define('FS_DB_PASS', 'Denergic9');

/*
 * Un directorio de nombre aleatorio para mejorar la seguridad del directorio temporal.
 */
define('FS_TMP_NAME', 'YwXOH07iQJjmpCafetId/');
...
define('FS_CACHE_PREFIX', 'vf7FZHmX_');
